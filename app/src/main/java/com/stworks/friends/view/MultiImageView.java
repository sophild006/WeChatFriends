...
import com.stworks.friends.bean.Images;
...
public class MultiImageView extends LinearLayout {
    ...
    private ImageView createImageView(int position, final boolean isMultiImage) {
        Images photoInfo = imagesList.get(position);
        ...
        imageView.setBackgroundColor(getResources().getColor(R.color.common_color_text_hint));
        ViewUtils.intoImageView(getContext(), photoInfo.getUrl(), imageView);
